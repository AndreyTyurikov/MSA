...
namespace DiscountMS.Host.Migrations
{
    ...
    [Migration("20231123095936_Added_Entity_SaleType_With_Prefill_Added_Entity_Personal_Discount")]
    partial class Added_Entity_SaleType_With_Prefill_Added_Entity_Personal_Discount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DiscountMS.Host.Domain.Model.DiscountAmountType", b =>
                {
                    ...
                    b.Property<string>("DiscountAmountTypeName")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DiscountAmountTypeName = "FixedAmount"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("DiscountMS.Host.Domain.Model.DiscountType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DiscountTypeId = 5,
                            DiscountTypeName = "InventoryItemUponInvoiceAmount"
                        });
                });
